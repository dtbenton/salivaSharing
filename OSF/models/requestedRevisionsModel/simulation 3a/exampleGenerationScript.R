#########################################################
# THOMAS MODEL EXAMPLE GENERATION SCRIPT: SIMULATION 3A #
#########################################################
...
## PRETRAINING ##
#################
setwd("C:/Users/bentod2/Documents/projects/current/salivaModel/model/requestedRevisionsModel/simulation 3a")
...
sink('test_exp_salivaANDNonsaliva_nonDistressed_nonComfort.ex')
cat(paste("defI:-", "\n", sep="\t"))
cat(paste("defT:-", "\n", sep="\t"))
cat(paste(";", "\n", sep="\t"))
...
# DISTRESS
cat(paste("(Distress_IN)", sep="\t"))
print(distress[2,1], sep = "\t", quote = FALSE, row.names = FALSE)
